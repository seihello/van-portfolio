  ...
  return (
    <div className={commonStyles.section}>
      ...
      <div className={styles.work_list}>
        <WorkExperience companyName="Sandman Media" companyLink="https://www.sandmanmedia.com/" duration="Jun. 2023 - Jul. 2023" position="Web Developer Internship" description={sandmanmediaDescription} image="/img/webdev.jpg" />
